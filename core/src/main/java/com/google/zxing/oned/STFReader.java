...
/**
 * <p>Implements decoding of the STF format, or Interleaved Two of Five.</p>
 *
 * <p>This Reader will scan STF barcodes of certain lengths only.
...
public final class STFReader extends OneDReader {
  ...
  /** Valid STF lengths. Anything longer than the largest value is also allowed. */
   ...
   */
  private static final int[] START_PATTERN = {W, N, W, N, N, N};
  private static final int[] END_PATTERN_REVERSED = {W, N, N, N, W, N};
  ...
  /**
   * Attempts to decode a sequence of STF black/white lines into single
   * digit.
   *
